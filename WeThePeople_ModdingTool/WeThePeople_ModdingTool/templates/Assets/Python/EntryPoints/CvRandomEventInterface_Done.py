def canTrigger$HARBOUR_NORMAL$TradeQuest_$YIELD_SHORT$_DONE(argsList):
	
	# Read Parameters 1+2 from the two events and check if enough yield is stored in city
	eEvent = gc.getInfoTypeForString("EVENT_$HARBOUR_UPPERCASE$_TRADE_QUEST_$YIELD_SHORT$_DONE_1")
